    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="主观题目" prop="zhuguantimu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhuguantimu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuguantimu" label="主观题目" prop="zhuguantimu">
                    <span v-html="ruleForm.zhuguantimu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zuoyeyaoqiu = true;
          ...
          if(o=='zhuguantimu'){
            this.ruleForm.zhuguantimu = obj[o];
	    this.ro.zhuguantimu = true;
            continue;
          }
          if(o=='faburiqi'){
	...
	this.ruleForm.zhuguantimu = this.ruleForm.zhuguantimu.replace(reg,'../../../springboot60a0e/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
